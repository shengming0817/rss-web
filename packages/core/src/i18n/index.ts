...
/**
 * createRssI18n — vue-i18n 11 factory for the rss web app.
 *
 ...
 * - missingWarn / fallbackWarn: false (silent). `@rss/core` has no vite/client types,
...
export function createRssI18n(): ReturnType<typeof createI18n> {
  ...
  return createI18n({
    ...
    messages,
    // Keeping warn flags false: @rss/core lacks vite/client types so
